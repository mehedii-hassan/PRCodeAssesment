...
import com.example.androidassesment.databinding.FragmentRegistrationPageBinding;
...
public class RegistrationPage extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.btnSubmitRP.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_registrationPage_to_loginPage);
            }
        });
    }
}